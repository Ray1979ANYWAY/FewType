...
const dicts: Record<Lang, Record<string, string>> = {
  ...
  "zh-CN": {
    ...
    "hotkey.mode_double_note": "第二下长按说话，松开发送",
  ...
  "zh-TW": {
    ...
    "hotkey.mode_double_note": "第二下按住說話，鬆手發送",
  ...
  "en-US": {
    ...
    "hotkey.mode_double_note": "Hold the second press to talk, release to send",

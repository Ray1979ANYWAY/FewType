...
const dicts: Record<Lang, Record<string, string>> = {
  ...
  "zh-CN": {
    ...
    // 语音输入
    "voice.hint": "在任意输入框按下快捷键，说话即可转成文字",
    "voice.no_mic": "需要麦克风",
    "voice.no_mic_title": "未检测到麦克风，请插入后重试",
    "voice.hold_hint": "按住模式 — 连按两下触发，按住不放说话，松开发送\n开关模式 — 连按两下开始录音，说完再连按两下结束",
    "voice.online": "服务在线",
    "voice.offline": "服务离线",
    "voice.restart": "重启服务",
    "voice.restart_title": "悬浮条卡住时点这里重启语音服务",
    "voice.mode_verbatim": "忠实记录",
    "voice.mode_fluent": "智能润色",
    "voice.mode_formal": "规范记录",
    "voice.mode_custom": "自定义风格",
    "voice.desc_verbatim": "只加标点，保留口头语",
    "voice.desc_fluent": "去除口头语，句子更通顺",
    "voice.desc_formal": "正式、规范的口吻",
    "voice.desc_custom": "用你自己的 Prompt 定义风格",
    "voice.style_placeholder": "选择自定义风格…",
    "voice.manage_styles": "配置风格…",
    "voice.style_karwai": "王家卫风格",
    "voice.auto_commit": "自动粘贴到光标处（Ctrl+V）",
    "voice.auto_translate": "自动翻译",
    "voice.mode_note": "「忠实记录」不加额外提示词，转写最快；其他模式会做风格化改写。",
    "voice.double_ctrl": "双击 Ctrl",

    // 电子书朗读
    "ebook.checking": "正在检测扩展…",
    "ebook.ready": "扩展已连接",
    "ebook.load": "加载 Chrome 扩展",
    "ebook.btn": "Chrome 扩展",
    "ebook.support": "支持",
    "ebook.platform_google": "Google Play 图书",
    "ebook.platform_koodo": "Koodo Reader",
    "ebook.platform_wechat": "微信读书",
    "ebook.missing":
      "未检测到扩展连接。请打开 chrome://extensions → 开启「开发者模式」→「加载已解压的扩展程序」→ 选择 FewType-extension 文件夹",
    "ebook.guide_title": "快速使用指南",
    "ebook.guide_1": "保持本程序后台运行即可",
    "ebook.guide_2": "在网页阅读器里用鼠标划选文本，自动开始朗读",
    "ebook.guide_3": "暂停/恢复：按 .（句号键，主键盘和小键盘均可）",
    "ebook.footer": "划选朗读由 Chrome 扩展完成，本程序保持后台运行即可",

    // 长文本转语音
    "tts.input_title": "输入文本",
    "tts.input_placeholder": "粘贴文本，语言不同时自动翻译，选音色生成音频",
    ...
    "settings.theme": "界面主题",
    "settings.theme_moss": "苔绿暗夜",
    "settings.theme_frost": "霜白",
    "settings.theme_midnight": "暮蓝",
    "settings.theme_ember": "余烬",
    "settings.check_update": "检查更新",
    "settings.checking": "检查中…",
    "settings.up_to_date": "已是最新版本",
    "settings.check_failed": "检查失败，请稍后重试",
    ...
    "hotkey.mode_double": "双击 Ctrl",
    "hotkey.mode_double_note": "按住模式 — 连按两下触发，按住不放说话，松开发送\n开关模式 — 连按两下开始录音，说完再连按两下结束",
  ...
  "zh-TW": {
    ...
    "voice.hint": "在任意輸入框按下快捷鍵，說話即可轉成文字",
    "voice.no_mic": "需要麥克風",
    "voice.no_mic_title": "未偵測到麥克風，請插入後重試",
    "voice.hold_hint": "按住模式 — 連按兩下觸發，按住不放說話，鬆手發送\n開關模式 — 連按兩下開始錄音，說完再連按兩下結束",
    "voice.online": "服務線上",
    "voice.offline": "服務離線",
    "voice.restart": "重新啟動服務",
    "voice.restart_title": "懸浮列卡住時點這裡重新啟動語音服務",
    "voice.mode_verbatim": "忠實記錄",
    "voice.mode_fluent": "智慧潤飾",
    "voice.mode_formal": "正式文件",
    "voice.mode_custom": "自訂風格",
    "voice.desc_verbatim": "只加標點，保留所有口頭語",
    "voice.desc_fluent": "去除口頭語，句子更順暢",
    "voice.desc_formal": "正式、規範的口吻",
    "voice.desc_custom": "用你自己的 Prompt 定義風格",
    "voice.style_placeholder": "選擇自訂風格…",
    "voice.manage_styles": "管理風格…",
    "voice.style_karwai": "王家衛風格",
    "voice.auto_commit": "自動貼上至游標處（Ctrl+V）",
    "voice.auto_translate": "自動翻譯",
    "voice.mode_note": "「忠實記錄」不加額外提示詞，轉寫最快；其他模式會做風格化改寫。",
    "voice.double_ctrl": "連按兩下 Ctrl",

    "ebook.checking": "正在偵測擴充功能…",
    "ebook.ready": "擴充功能已連線",
    "ebook.load": "載入 Chrome 擴充功能",
    "ebook.btn": "Chrome 擴充功能",
    "ebook.support": "支援",
    "ebook.platform_google": "Google Play 圖書",
    "ebook.platform_koodo": "Koodo Reader",
    "ebook.platform_wechat": "微信閱讀",
    "ebook.missing":
      "未偵測到擴充功能連線。請開啟 chrome://extensions → 開啟「開發者模式」→「載入未封裝項目」→ 選擇 FewType-extension 資料夾",
    "ebook.guide_title": "快速使用指南",
    "ebook.guide_1": "保持本程式在背景執行即可",
    "ebook.guide_2": "在網頁閱讀器中用滑鼠選取文字，自動開始朗讀",
    "ebook.guide_3": "暫停/繼續：按 .（句號鍵，主鍵盤和數字鍵盤均可）",
    "ebook.footer": "選取朗讀由 Chrome 擴充功能完成，本程式保持背景執行即可",

    "tts.input_title": "輸入文字",
    "tts.input_placeholder": "貼上文字，語言不同時自動翻譯，選聲音產生音檔",
    ...
    "tts.volume_title": "音量提升（edge-tts prosody）",
    "tts.note": "輸入與輸出語言一致時自動跳過翻譯 · 聲音即時擷取，可能需要等待",
    ...
    "tts.ready": "就緒",
    "tts.voices_loaded": "已載入 {n} 個聲音",
    "tts.status_input_first": "請先輸入或貼上文字",
    "tts.status_voice_first": "請先選擇聲音",
    ...
    "tts.status_translated": "翻譯完成，可編輯後產生音檔",
    ...
    "tts.status_voices_failed": "聲音載入失敗（後端未啟動？）",
    "tts.busy": "處理中…",

    "settings.general": "一般",
    "settings.ui_lang": "介面語言",
    "settings.autostart": "開機時自動啟動本程式（常駐背景）",
    "settings.theme": "介面主題",
    "settings.theme_moss": "苔綠暗夜",
    "settings.theme_frost": "霜白",
    "settings.theme_midnight": "暮藍",
    "settings.theme_ember": "餘燼",
    "settings.check_update": "檢查更新",
    "settings.checking": "檢查中…",
    "settings.up_to_date": "已是最新版本",
    "settings.check_failed": "檢查失敗，請稍後重試",
    "settings.service": "語音服務",
    "settings.provider": "服務供應商",
    "settings.advanced": "進階設定",
    "settings.hotkey": "語音輸入快速鍵",
    ...
    "hotkey.mode_combo": "自訂組合鍵",
    "hotkey.mode_combo_placeholder": "在此按下組合鍵…",
    "hotkey.mode_combo_note": "點擊框內，按下組合鍵即預覽",
    "hotkey.mode_double": "連按兩下 Ctrl",
    "hotkey.mode_double_note": "按住模式 — 連按兩下觸發，按住不放說話，鬆手發送\n開關模式 — 連按兩下開始錄音，說完再連按兩下結束",
    ...
    "about.subtitle": "語音輸入 · 電子書朗讀 · 長文字轉語音",
    "about.made_by": "Made by Ray",
  ...
  "en-US": {
    ...
    "voice.hold_hint": "Hold the second press to talk,\nor press twice to toggle",
    "voice.online": "Service online",
    "voice.offline": "Service offline",
    "voice.restart": "Restart service",
    "voice.restart_title": "If the floating bar freezes, click here to restart the voice service",
    "voice.mode_verbatim": "Verbatim",
    "voice.mode_fluent": "Smart Polish",
    "voice.mode_formal": "Formal",
    "voice.mode_custom": "Custom Style",
    "voice.desc_verbatim": "Punctuation only — keeps every filler word",
    "voice.desc_fluent": "Removes filler words, smooths out sentences",
    "voice.desc_formal": "Rewrites into a formal, clean document",
    "voice.desc_custom": "Define the style with your own prompt",
    "voice.style_placeholder": "Choose a style…",
    "voice.manage_styles": "Manage styles…",
    "voice.style_karwai": "Karwai Wong style",
    "voice.auto_commit": "Auto-paste to cursor position (Ctrl+V)",
    "voice.auto_translate": "Auto-translate",
    "voice.mode_note": "Verbatim runs with no extra prompt — fastest transcription; other modes apply stylized rewriting.",
    "voice.double_ctrl": "Double-press Ctrl",

    "ebook.checking": "Checking extension…",
    "ebook.ready": "Extension connected",
    "ebook.load": "Load Chrome extension",
    "ebook.btn": "Chrome Extension",
    "ebook.support": "Supports",
    "ebook.platform_google": "Google Play Books",
    "ebook.platform_koodo": "Koodo Reader",
    "ebook.platform_wechat": "WeChat Read",
    "ebook.missing":
      "Extension not connected. Open chrome://extensions → enable \"Developer mode\" → \"Load unpacked\" → select the FewType-extension folder",
    "ebook.guide_title": "Quick Start Guide",
    "ebook.guide_1": "Keep this app running in the background",
    "ebook.guide_2": "In a web reader, select text with your mouse to start reading aloud",
    "ebook.guide_3": "Pause/resume: . (period — main keyboard & numpad)",
    "ebook.footer": "Reading selected text is handled by the Chrome extension; this app just needs to stay in the background",
    ...
    "tts.output_lang": "Output Language",
    "tts.rate": "Speed",
    "tts.voice": "Voice",
    "tts.volume": "Volume",
    ...
    "settings.theme_moss": "Moss",
    "settings.theme_frost": "Frost",
    ...
    "settings.check_failed": "Check failed, try again later",
    ...
    "hotkey.mode_combo": "Custom Shortcut",
    ...
    "hotkey.mode_double": "Double-press Ctrl",
    "hotkey.mode_double_note": "Hold mode — double-press to activate, hold to talk, release to send\nToggle mode — double-press to start, double-press again to stop",

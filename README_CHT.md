...
1. 從 [Releases](https://github.com/Ray1979ANYWAY/FewType/releases) 下載最新安裝版或便攜版。
...
- 這是一個活躍維護的個人專案——能力可能隨版本變化。Bug 與建議歡迎提交到 [Issues](https://github.com/Ray1979ANYWAY/FewType/issues)。

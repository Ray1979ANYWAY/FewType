...
const I18N = {
  "zh-CN": {
    ...
    refreshHint: "如果没有抓取到文本，请按 F5 刷新页面",
    voicesLoading: "音色正在加载中…",
    metaEmpty: "尚未提取正文",
    noText:
  ...
  "zh-TW": {
    ...
    metaEmpty: "尚未擷取正文",
    refreshHint: "如果沒有擷取到文字，請按 F5 重新整理頁面",
    voicesLoading: "音色正在載入中…",
    noText:
  ...
  en: {
    ...
    refreshHint: "If no text is extracted, press F5 to refresh the page",
  ...
  es: {
    ...
    refreshHint: "Si no se extrae texto, presiona F5 para actualizar la página",
  ...
  ja: {
    ...
    refreshHint: "テキストが抽出されない場合は、F5 キーを押してページを更新してください",
    voicesLoading: "音声を読み込み中…",
    noText:
  ...
  ko: {
    ...
    refreshHint: "텍스트가 추출되지 않으면 F5 키를 눌러 페이지를 새로고침하세요",
    voicesLoading: "음성 로딩 중…",
    noText:
...
// 心跳：popup 打开时直接向本地桥接服务发送一次心跳，标记扩展在线。
// 为什么放在 popup.js 而不是 background.js：
